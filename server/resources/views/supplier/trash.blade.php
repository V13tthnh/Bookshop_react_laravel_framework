...
<div class="container-fluid pt-4 px-4">
    <div class="bg-secondary text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h6 class="mb-0">Danh Sách Hàng Đã Hủy</h6>
            <a href="">Show All</a>
        </div>
                ...
                <tbody>
                    ...
                    @forelse($trash as $item)
                        <tr>
                            ...
                            <td>   
                            <td>   
                                <a type="button" href="{{route('supplier.untrash', $item->id)}}" class="btn btn-rectangle btn-info m-2"><i class="fa fa-trash-restore"></i></a>
                            </td>  
