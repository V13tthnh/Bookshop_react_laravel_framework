                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4>
                                ...
                                <small class="float-right">Ngày: {{$orderDetail->created_at}}</small>
                            </h4>
                        </div>
                        <!-- /.col -->
                    </div>
                    ...
                    <div class="row invoice-info">
                        <div class="col-sm-4 invoice-col">
                            ...
                            <address>
                                ...
                                SĐT: {{$orderDetail->customer->phone}}<br>
                            </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                        ...
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                            <b>Invoice #{{$orderDetail->id}}</b><br>
                            <br>
                            <b>Order ID:</b> {{$orderDetail->id}}<br>
                            <b>Payment Due:</b> #{{$orderDetail->format}}<br>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-12 table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @forelse($orderDetail->orderDetails as $item)
                                        <tr>
                                            <td>{{$item->id}}</td>
                                            <td>{{$item->book != null ? $item->book->name : 'N/A'}}</td>
                                            <td>{{$item->combo != null ? $item->combo->name : 'N/A'}}</td>
                                            <td>{{$item->quantity}}</td>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td>{{number_format(45000, 0, '', ',')}} vnđ</td>
                                    </tr>
                                    <!-- <tr>
                                        <th>Tax (9.3%)</th>
                                        <td>$10.34</td>
                                    ...
                                    <tr>
                                        <th>Total:</th>
                                        <td>{{number_format($orderDetail->total, 0, '', ',')}} vnđ</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
