...
<head>
    <meta charset="utf-8">
    <title>Login To BookShop DashBoard</title>
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-book me-2"></i>BookShop</h3>
                            </a>
                            <h3>Sign In</h3>
                        </div>
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('admin.loginHandler')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\Code\laravel\ung_dung_laravel_react_vao_do_an_ban_sach\client\resources\views/admin/login.blade.php ENDPATH**/ ?>