...
class AddDataToDBSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $admin4 = new admin();
        $admin4->name = 'Admin 3';
        $admin4->email = 'admin3@example.com';
        $admin4->email_verified_at = '';
        $admin4->password = Hash::make('admin789');
        $admin4->remember_token = '';
        $admin4->save(); // Save the admin3 object to the database

        $admin5 = new admin();
        $admin5->name = 'Admin 4';
        $admin5->email = 'admin4@example.com';
        $admin5->email_verified_at = '';
        $admin5->password = Hash::make('admin101');
        $admin5->remember_token = '';
        $admin5->save(); // Save the admin4 object to the database
